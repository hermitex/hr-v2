      ...
      <Card sx={{ display: 'flex', padding: '2%' }}>
        <CardContent>
          <Grid container xs={12}>
            ...
            <Grid item xs={6} sm={4}>
              <Typography sx={{ fontSize: '12px' }}>Your organization setups are incomplete</Typography>
              <Typography sx={{ fontSize: '12px' }}>
                Please set up your organization before using the system{' '}
              </Typography>
            </Grid>
